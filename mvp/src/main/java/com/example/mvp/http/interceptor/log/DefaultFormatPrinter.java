package com.example.mvp.http.interceptor.log;

import android.text.TextUtils;

import com.example.mvp.utils.CharacterHandler;
...
public class DefaultFormatPrinter implements FormatPrinter {
     ...
     * <p>
     * 此问题引起的原因, 猜测可能是因为 AndroidStudio v3.1 以上将极短时间内以相同 tag 输出多次的 log 自动合并为一次输出
